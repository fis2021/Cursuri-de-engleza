...
public class AddLessonsTeacherController implements Initializable {

    //Back Button -> TeacherLessons.fxml
    public void backButtonTeacher(ActionEvent event) throws IOException {
        Parent parent5 = FXMLLoader.load(getClass().getResource("/javafx/TeacherLessons.fxml"));

        Scene parent5_scene = new Scene(parent5);
        Stage parent5_stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        parent5_stage.setScene(parent5_scene);
        parent5_stage.show();
    }
